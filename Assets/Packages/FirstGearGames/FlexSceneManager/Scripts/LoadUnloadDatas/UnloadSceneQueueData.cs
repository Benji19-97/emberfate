...
namespace FirstGearGames.FlexSceneManager.LoadUnloadDatas
{
    ...
    public class UnloadSceneQueueData
    {
        ...
        public UnloadSceneQueueData(SceneScopeTypes scopeType, NetworkConnection[] conns, AdditiveScenesData additiveScenes,UnloadOptions unloadOptions, NetworkedScenesData networkedScenes, bool asServer)
        {
            ScopeType = scopeType;
            Connections = conns;
