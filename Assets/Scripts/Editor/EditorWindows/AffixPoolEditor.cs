...
namespace Ayaya
{
    ...
    public class AffixPoolEditor : EditorWindow
    {
        ...
        [MenuItem("Data/Affix Pool Editor")]
        ...
        private void OnGUI()
        {
            ...
            {
                GUILayout.Space(2);
                _target.collection = EditorGUILayout.ObjectField(_target.collection, typeof(AffixCollection), GUILayout.Width(350)) as AffixCollection;
                GUILayout.Space(8);
